  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between transition-all duration-300">
        ...
        {/* Desktop Navigation Links with Animated Scale & Underline */}
        <div className="hidden md:flex items-center transition-all duration-300 space-x-6 lg:space-x-10">
          ...
          {/* Login Dropdown Pill Button with Dynamic Size & Pulse Effect */}
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <svg
                ...
                } ${isLoginOpen ? 'rotate-180 text-[#e53238]' : 'text-gray-500'}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2.5}
            ...
            {/* Dropdown Menu with Pop-in Animation */}
            {isLoginOpen && (
              <div className="absolute right-0 mt-3 w-72 bg-white rounded-2xl shadow-xl border border-gray-100 py-3 z-50 origin-top-right transition-all duration-200 animate-in fade-in zoom-in-95 slide-in-from-top-3">
                ...
                <Link
                  ...
                  className="flex items-center gap-3.5 px-5 py-3 text-sm text-gray-700 hover:bg-red-50/80 hover:text-[#e53238] transition-colors group"
                >
        ...
        <div className="flex md:hidden items-center space-x-3">
          ...
          >
            <span>Login</span>
            <svg
              className={`w-3 h-3 text-gray-500 transition-transform ${isLoginOpen ? 'rotate-180' : ''}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2.5}
      ...
      {/* Mobile Drawer Menu with Fade & Slide Animation */}
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white/98 backdrop-blur-lg px-4 pt-4 pb-6 space-y-3 shadow-lg animate-in slide-in-from-top-4 duration-200">
          ...
          <div className="pt-3 border-t border-gray-100">
            <Link
              href="/auth/login"
              onClick={() => setIsMobileMenuOpen(false)}
              className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-[#e53238] text-white font-semibold text-base shadow-md hover:bg-[#c92429] active:scale-98 transition-all"
            >
              Member Login
            </Link>
          </div>
